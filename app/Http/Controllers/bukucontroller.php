...
class BukuController extends Controller
{
       ...
       try{
               ...
               if($request->hasfile('foto'))
               {
                   foreach($request->file('foto') as $filegambar){
                       ...
                       $uploadgambar =$filegambar->move(public_path().'/foto_buku/',$fileasli);
           ...
           return redirect()->back()->withErrors(['buku gagal disimpan'])->withInput();
       }
    ...
    public function edit($id)
   {
        $kategori = Kategori::distinct('name')->get();
        $buku = Buku::find($id);
        return view('buku.edit')->with('buku',$buku)->withkategori($kategori);
   }
    /**
 ...
 *
    ...
    public function update(Request $request, $id)
   {
      ...
      try{
           ...
           return redirect()->back()->withErrors(['buku gagal diperbarui'])->withInput();
       }
